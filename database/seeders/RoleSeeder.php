...
{
    public const DOMAINS = ['companies', 'persons', 'documents', 'tasks', 'compliance', 'experts', 'finance', 'projects', 'investments', 'production', 'participations', 'hr', 'graph', 'datalake', 'ai', 'executive'];
