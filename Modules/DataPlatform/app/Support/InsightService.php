...
/**
 * Regelbasierte Insights ueber die operativen Tabellen eines Mandanten.
 * Regeln sind austauschbar — spaeter kann dieselbe Schnittstelle von
 * einem LLM-Service befuellt werden.
 */
class InsightService
{
    public function collect(string $t): array
    {
