...
class DemoSeedTest extends TestCase
{
    ...
    public function test_demo_seed_populates_all_domains_idempotently(): void
    {
        ...
        $this->assertGreaterThanOrEqual(3, Audit::count());
        $this->assertGreaterThanOrEqual(1, AuditFinding::count());
        $this->assertSame(1, Answer::count());
        $this->assertSame(1, TenderApplication::count());
        $this->assertGreaterThanOrEqual(2, GraphEntity::count());
        $this->assertSame(1, GraphEdge::count());
