...
function workspace(initial) {
    ...
    return {
        ...
        kbd(e) {
            ...
            else if (e.key === 'r') { if (!this.showCreate && !this.palette && !['dashboard','executive'].includes(this.section)) { if (this.detail) this.reloadRow(); else this.loadSection(true); } }
