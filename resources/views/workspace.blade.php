...
function workspace(initial) {
    ...
    return {
        ...
        insightSection(code) { return ({tasks_overdue:'tasks',tasks_due_soon:'tasks',deadlines_due_soon:'deadlines',inspections_due_soon:'inspections',compliance_rate_low:'instructions',high_risks_open:'risk-assessments',deadlines_overdue:'deadlines',tenders_open:'tenders',inspections_overdue:'inspections',leave_requests_pending:'leave-requests'})[code] || null; },
        insightFilter(code) { return ({tasks_overdue:'overdue=1',tasks_due_soon:'dueSoon=1',deadlines_due_soon:'dueSoon=1',inspections_due_soon:'dueSoon=1',deadlines_overdue:'overdue=1',high_risks_open:'status=open',tenders_open:'status=open',inspections_overdue:'overdue=1',leave_requests_pending:'status=pending'})[code] || ''; },
