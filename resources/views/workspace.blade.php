...
function workspace(initial) {
    ...
    const FKMAP = {person_id:'persons',company_id:'companies',machine_id:'machines',project_id:'projects',strategy_id:'strategies',portfolio_id:'portfolios',tender_id:'tenders',question_id:'questions',document_id:'documents',expert_profile_id:'expert_profiles',responsible_id:'users',assignee_id:'users',owner_id:'users',asked_by:'users',approved_by:'users',answered_by:'users',created_by:'users',uploaded_by:'users',generated_by:'users',current_version_id:'documents',assigned_to:'persons',from_entity_id:'graph_entities',to_entity_id:'graph_entities',subject_id:'graph_entities'};
    ...
    return {
        ...
        insightSection(code) { return ({tasks_overdue:'tasks',tasks_due_soon:'tasks',deadlines_due_soon:'deadlines',inspections_due_soon:'inspections',fin_negative_liquidity:'financial-reports',machines_in_maintenance:'machines',orders_overdue:'production-orders',orders_due_soon:'production-orders',risk_reviews_overdue:'risk-assessments',measures_overdue:'measures',measures_due_soon:'measures',projects_overdue:'projects',projects_ending_soon:'projects',instructions_due_soon:'instructions',instructions_overdue:'instructions',compliance_rate_low:'instructions',high_risks_open:'risk-assessments',deadlines_overdue:'deadlines',tenders_open:'tenders',questions_open:'questions',tenders_deadline_soon:'tenders',investments_drawdown:'investments',strategies_overdue:'strategies',participations_capital_need:'participations',inspections_overdue:'inspections',leave_requests_pending:'leave-requests'})[code] || null; },
        insightFilter(code) { return ({tasks_overdue:'overdue=1',tasks_due_soon:'dueSoon=1',deadlines_due_soon:'dueSoon=1',inspections_due_soon:'dueSoon=1',fin_negative_liquidity:'',machines_in_maintenance:'status=maintenance',orders_overdue:'overdue=1',orders_due_soon:'dueSoon=1',risk_reviews_overdue:'overdue=1',measures_overdue:'overdue=1',measures_due_soon:'dueSoon=1',projects_overdue:'overdue=1',projects_ending_soon:'dueSoon=1',instructions_due_soon:'dueSoon=1',instructions_overdue:'overdue=1',deadlines_overdue:'overdue=1',high_risks_open:'status=open',tenders_open:'status=open',questions_open:'status=open',tenders_deadline_soon:'dueSoon=1',investments_drawdown:'',strategies_overdue:'overdue=1',participations_capital_need:'status=active',inspections_overdue:'overdue=1',leave_requests_pending:'status=pending'})[code] || ''; },
