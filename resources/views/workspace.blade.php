...
function workspace(initial) {
    ...
    const NOTIF_KIND = {unterweisung:'Unterweisung',pruefung:'Prüfung',frist:'Frist',feststellung:'Feststellung',audit:'Audit',massnahme:'Maßnahme',aufgabe:'Aufgabe',gefaehrdungsbeurteilung:'Gefährdungsbeurteilung',projekt:'Projekt',auftrag:'Produktionsauftrag',ausschreibung:'Ausschreibung'};
    ...
    return {
        ...
        insightSection(code) { return ({tasks_overdue:'tasks',tasks_due_soon:'tasks',tasks_unassigned:'tasks',deadlines_due_soon:'deadlines',deadlines_unassigned:'deadlines',inspections_due_soon:'inspections',inspections_unassigned:'inspections',fin_negative_liquidity:'financial-reports',fin_reports_missing:'financial-reports',machines_in_maintenance:'machines',orders_overdue:'production-orders',orders_due_soon:'production-orders',orders_unassigned:'production-orders',orders_no_machine:'production-orders',orders_machine_maintenance:'production-orders',machines_idle:'machines',instructions_no_person:'instructions',projects_no_owner:'projects',investments_stale_value:'investments',documents_no_category:'documents',expert_profiles_no_rate:'expert-profiles',persons_no_contact:'persons',leave_overlap:'leave-requests',applications_no_price:'tenders',applications_stale:'tenders',audits_no_findings:'audits',audits_no_result:'audits',instructions_no_completed_at:'instructions',risk_assessments_no_person:'risk-assessments',ai_analyses_failed:'ai-analyses',tenders_no_budget:'tenders',machines_zero_capacity:'machines',inspections_no_person:'inspections',instructions_renewal_due:'instructions',data_objects_no_category:'data-objects',graph_edges_no_relation:'graph-edges',measures_no_project:'measures',projects_stalled:'projects',questions_unassigned:'questions',questions_no_answers:'questions',deadlines_no_subject:'deadlines',risk_reviews_overdue:'risk-assessments',risk_reviews_due_soon:'risk-assessments',measures_overdue:'measures',measures_due_soon:'measures',measures_unassigned:'measures',projects_overdue:'projects',projects_ending_soon:'projects',projects_unassigned:'projects',projects_no_measures:'projects',portfolios_no_investments:'portfolios',instructions_due_soon:'instructions',instructions_overdue:'instructions',instructions_unassigned:'instructions',compliance_rate_low:'instructions',high_risks_open:'risk-assessments',deadlines_overdue:'deadlines',tenders_open:'tenders',questions_open:'questions',questions_stale:'questions',graph_orphans:'graph-entities',tenders_deadline_soon:'tenders',tenders_overdue:'tenders',tenders_no_applications:'tenders',expert_profiles_incomplete:'expert-profiles',documents_no_version:'documents',persons_without_company:'persons',companies_no_persons:'companies',investments_drawdown:'investments',strategies_overdue:'strategies',strategies_no_projects:'strategies',strategies_ending_soon:'strategies',participations_capital_need:'participations',inspections_overdue:'inspections',inspections_no_result:'inspections',leave_requests_pending:'leave-requests',leave_pending_stale:'leave-requests',leave_active_today:'leave-requests',audit_findings_overdue:'audit-findings',audit_findings_critical:'audit-findings',audit_findings_due_soon:'audit-findings',audit_findings_unassigned:'audit-findings',audits_starting_soon:'audits',audits_overdue:'audits',audits_unassigned:'audits',op_instructions_draft:'operating-instructions',op_instructions_review:'operating-instructions',op_instructions_no_document:'operating-instructions',instructions_no_document:'instructions'})[code] || null; },
        insightFilter(code) { return ({tasks_overdue:'overdue=1',tasks_due_soon:'dueSoon=1',tasks_unassigned:'unassigned=1',deadlines_due_soon:'dueSoon=1',deadlines_unassigned:'unassigned=1',inspections_due_soon:'dueSoon=1',inspections_unassigned:'unassigned=1',fin_negative_liquidity:'',fin_reports_missing:'',machines_in_maintenance:'status=maintenance',orders_overdue:'overdue=1',orders_due_soon:'dueSoon=1',orders_unassigned:'unassigned=1',orders_no_machine:'',orders_machine_maintenance:'',machines_idle:'status=active',instructions_no_person:'status=pending',projects_no_owner:'status=active',investments_stale_value:'',documents_no_category:'',expert_profiles_no_rate:'status=active',persons_no_contact:'',leave_overlap:'status=approved',applications_no_price:'',applications_stale:'status=submitted',audits_no_findings:'status=done',audits_no_result:'status=done',instructions_no_completed_at:'status=completed',risk_assessments_no_person:'status=open',ai_analyses_failed:'status=failed',tenders_no_budget:'status=open',machines_zero_capacity:'status=active',inspections_no_person:'status=scheduled',instructions_renewal_due:'status=completed',data_objects_no_category:'',graph_edges_no_relation:'',measures_no_project:'',projects_stalled:'status=active',questions_unassigned:'status=open',questions_no_answers:'',deadlines_no_subject:'status=open',risk_reviews_overdue:'overdue=1',risk_reviews_due_soon:'dueSoon=1',compliance_rate_low:'',graph_orphans:'',leave_pending_stale:'status=pending',measures_overdue:'overdue=1',measures_due_soon:'dueSoon=1',measures_unassigned:'unassigned=1',projects_overdue:'overdue=1',projects_ending_soon:'dueSoon=1',projects_unassigned:'unassigned=1',projects_no_measures:'status=active',portfolios_no_investments:'',instructions_due_soon:'dueSoon=1',instructions_overdue:'overdue=1',instructions_unassigned:'unassigned=1',deadlines_overdue:'overdue=1',high_risks_open:'status=open',tenders_open:'status=open',questions_open:'status=open',questions_stale:'status=open',tenders_deadline_soon:'dueSoon=1',tenders_overdue:'overdue=1',tenders_no_applications:'status=open',expert_profiles_incomplete:'status=active',documents_no_version:'',persons_without_company:'',companies_no_persons:'',investments_drawdown:'',strategies_overdue:'overdue=1',strategies_no_projects:'status=active',strategies_ending_soon:'dueSoon=1',participations_capital_need:'status=active',inspections_overdue:'overdue=1',inspections_no_result:'status=completed',leave_requests_pending:'status=pending',leave_active_today:'status=approved',audit_findings_overdue:'overdue=1',audit_findings_critical:'severity=critical',audit_findings_due_soon:'dueSoon=1',audit_findings_unassigned:'unassigned=1',audits_starting_soon:'status=planned',audits_overdue:'overdue=1',audits_unassigned:'unassigned=1',op_instructions_draft:'status=draft',op_instructions_review:'status=active',op_instructions_no_document:'',instructions_no_document:''})[code] || ''; },
